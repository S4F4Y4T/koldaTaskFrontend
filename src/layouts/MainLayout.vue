...
const adminNavigation = [
  ...
  { name: 'Roles & Permissions', to: 'roles', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
];
</script>
    ...
    >
      ...
      <nav class="flex-1 py-6 px-3 space-y-2 overflow-y-auto">
        ...
        <div class="mt-6 mb-2 px-3">
          <p v-if="isSidebarOpen" class="text-xs font-semibold text-slate-500 uppercase tracking-wider mb-2">Admin</p>
          <div v-else class="h-px bg-slate-800 my-2"></div>
        </div>
